...
.defines(function(){
    ...
    EntityFountain = ig.Entity.extend({
        ...
        colorOffset: 2,
        size: {x: 8, y: 8},
        particleType: "EntityWaterParticle",
        ...
        update: function() {
            if( this.idleTimer.delta() > this.lifetime ) {
                for(var i=0; i < this.particles; i++)
                    ig.game.spawnEntity(this.particleType, (Math.random() * this.size.x) + this.pos.x, this.pos.y, {colorOffset: this.colorOffset, alpha: this.alpha});
